...
likeRouter.route('/recipe/:recipe_id').get(
  /**
...
likeRouter.route('/user/:user_id').get(
  /**
...
likeRouter.route('/recipe/:recipe_id/user/:user_id').get(
  /**
...
likeRouter.route('/recipe/:recipe_id/user').get(
  /**
   * @api {get} /likes/recipe/:recipe_id/user Get like by recipe ID for authenticated user
   * @apiName LikeByRecipeIdForCurrentUserGet
   * @apiGroup LikeGroup
   * @apiVersion 1.0.0
   * @apiDescription Get like by recipe ID for the authenticated user
   * @apiPermission token
   *
   * @apiParam {Number} recipe_id Recipe ID
   *
   * @apiSuccess {Object} like Like object or null if not found
   * @apiSuccess {Number} like.like_id Like ID
   * @apiSuccess {Number} like.recipe_id Recipe ID
   * @apiSuccess {Number} like.user_id User ID
   * @apiSuccess {Date} like.created_at Created at
