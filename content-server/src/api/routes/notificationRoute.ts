...
notificationRouter.route('/user/:id/mark-read').put(
  /**
...
notificationRouter.route('/user/mark-read/all').put(
  /**
   * @api {put} /notifications/user/:id/mark-read/all Mark All Notification as Read
   * @apiName MarkNotificationAllAsRead
   * @apiGroup notificationGroup
   * @apiVersion 1.0.0
...
notificationRouter.route('/user/:id/archive').put(
  /**
...
notificationRouter.route('/delete/old').delete(
  /**
...
notificationRouter.route('/user/enabled/:id').get(
  /**
...
notificationRouter.route('/settings/toggle-enabled').put(
  /**
